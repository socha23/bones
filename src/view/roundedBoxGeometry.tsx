...
function getUv( faceDirVector: Vector3, normal: Vector3, uvAxis: keyof Vector3, projectionAxis: keyof Vector3, radius: number, sideLength: number ) {
...
interface RoundedBoxGeometryParams {
    width?:  number,
    height?: number,
    depth?: number,
    segments?: number,
...
export class RoundedBoxGeometry extends BoxGeometry {
    ...
    params: RoundedBoxGeometryParams
    type: string
	/**
	 ...
	 */
	static fromJSON( data: RoundedBoxGeometryParams ) {
